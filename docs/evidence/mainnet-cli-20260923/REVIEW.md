...
- Native unit tests and clippy passed. Launcher/package tests passed (14). Canonical contract-backed acceptance passed 105 tests with zero skip messages, including two-proof continuous mining, real local funding, NFT ownership after restart, and exact signed-transaction recovery after a lost reply. Foundry 1.7.1 used isolated local Anvil nodes. Release asset verification remains separate.
